...
| Ua      | Uə̯ | ưa, ươ                 | lươn lẹo      | [l Ua N l e w]  |      |
...
- Only [ae] and [oe] couldn't neatly be represented by one letter, so I had to settled for diagraphs. [e] was chosen because any other vowels would result in it being misread as a dipthongs.
## Final consonants
...
| w       | w   | (q)u, (th)o            | khô th**o**áng  | [kh O th w a NG]    | This sound only occurs as a glide in the Northern dialect. |
# Southern Exclusives
| Phoneme | IPA   | Written representation | Example       | Phonetic       | Note |
| ------- | ----- | ---------------------- | ------------- | -------------- | ---- |
